...
seo-title: Mise à jour de plusieurs points d’intérêt
description: Utilisez les API par lot pour mettre à jour plusieurs points d’intérêt.
seo-description: Utilisez les API par lot pour mettre à jour plusieurs points d’intérêt.
...
Voici l’exemple de fichier JSON pour l’ `batchUpdate` API :
