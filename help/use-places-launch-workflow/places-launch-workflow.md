...
description: Cette section fournit des informations sur la définition d’éléments de données et la création de règles d’entrée et de sortie dans Experience Platform Launch qui peuvent être utilisées avec Places Service.
...
* Pour définir des éléments de données, voir [Définir des éléments de données](/help/use-places-launch-workflow/define-data-elements.md).
