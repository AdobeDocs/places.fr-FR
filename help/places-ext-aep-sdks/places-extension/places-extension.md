...
Accédez au portail destiné aux développeurs Adobe pour afficher la documentation relative à la [Extensions du SDK Places](https://developer.adobe.com/client-sdks/documentation/places/).
